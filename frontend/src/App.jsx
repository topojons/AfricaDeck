        ...
        <div className="max-w-[1920px] mx-auto px-4 py-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-base font-bold tracking-tight"><span className="text-green-400">Nigeria</span><span className="text-white">Deck</span><span className="text-[10px] font-normal text-gray-500 ml-2">by Olayinka Ayeni</span></h1>
